...
def CNNUpdate(model, eps, momentum):
    ...
    model['v4'] = momentum*model['v4']+eps*model['dE_db1']
    model['v5'] = momentum*model['v5']+eps*model['dE_db2']
    model['v6'] = momentum*model['v6']+eps*model['dE_db3']
...
def main():
    ...
    #plt.imshow(model['W1'][:, 1].reshape(5, 5), cmap=plt.cm.gray)
    #plt.draw()
    #plt.pause(1)
