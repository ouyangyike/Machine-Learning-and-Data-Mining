...
if __name__ == '__main__':
    ...
    # TODO generate plots
    plt.plot(logging[:,3],marker='+',label='weight decay=0.001')
    ...
    # TODO generate plots
    plt.plot(logging[:,3],marker='H',label='weight decay=0.01')
    ...
    # TODO generate plots
    plt.plot(logging[:,3],marker='d',label='weight decay=0.1')
    ...
    # TODO generate plots
    plt.plot(logging[:,3],marker='h',label='weight decay=1.0')
    
    plt.legend(loc='upper right')
    plt.title('Plot of Loss vs. Iteration Times on validation set')
