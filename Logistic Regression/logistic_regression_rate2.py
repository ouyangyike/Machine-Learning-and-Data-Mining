...
if __name__ == '__main__':
    ...
    # TODO generate plots 
    plt.plot(logging[:,3],marker='*',label='learning rate=0.3')
    ...
    # TODO generate plots 
    plt.plot(logging[:,3],marker='d',label='learning rate=0.5')
    ...
    # TODO generate plots 
    plt.plot(logging[:,3],marker='h',label='learning rate=0.7')
    ...
    # TODO generate plots 
    plt.plot(logging[:,3],marker='s',label='learning rate=0.9')
    ...
    plt.ylabel('Cross Entropy of Validation Set')
    plt.show()
