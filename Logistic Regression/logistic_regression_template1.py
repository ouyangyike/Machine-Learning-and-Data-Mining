...
if __name__ == '__main__':
    ...
    print logging[299:300,:] #show final result
    # TODO generate plots
    plt.figure(1)
    ...
    plt.figure(2)
    plt.plot(logging[:,2],marker='d',label='training set')
    plt.plot(logging[:,4],marker='D',label='validation set')
    plt.plot(logging[:,6],marker='H',label='test set')
